...
namespace eduzone
{
    class TeacherClass
    {
        ...
        //public bool addStudent(string fname, string lname, DateTime bdate, string gender, string phone, string address, byte[] photo)
        {
            ...
            SqlCommand command = new SqlCommand("INSERT INTO [Teacher] (StdFirstName, StdLastName, BirthDate, Gender, Phone, Address,Photo) VALUES (@fn, @ln, @birth, @gn, @num, @address,@img)");
        ...
        {
            SqlCommand command = new SqlCommand("SELECT * FROM [Teacher]", connect.getconnection);
        ...
        {
            SqlCommand command = new SqlCommand("SELECT * FROM [Teacher] WHERE Stdid LIKE '%" + searchInformation + "%' OR StdFirstName LIKE '%" + searchInformation + "%' OR StdLastName LIKE '%" + searchInformation + "%' OR Phone LIKE '%" + searchInformation + "%'", connect.getconnection);
